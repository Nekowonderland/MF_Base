...
dwR.results = {{type="item", name="DimensionalWire", amount=1}}
data:extend{dwR}
...
dcR.results = {{type="item", name="DimensionalCircuit", amount=1}}
data:extend{dcR}
...
ccR.results = {{type="item", name="CrystalizedCircuit", amount=4}}
data:extend{ccR}
